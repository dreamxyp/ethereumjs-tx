...
const common = require('icjs-common/params.json')

var txTests = testing.getTests('transaction', argv)

const bufferToHex  = ircUtil.bufferToHex
const addHexPrefix = ircUtil.addHexPrefix
const stripHexPrefix = ircUtil.stripHexPrefix
const setLength = ircUtil.setLength
...
tape('[FakeTransaction]: Basic functions', function (t) {
    ...
    try {
      var rawTx = ircUtil.toBuffer(testData.rlp)
      var tx = new Tx(rawTx)
